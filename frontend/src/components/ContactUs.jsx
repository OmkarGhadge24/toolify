...
const ContactUs = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.description) newErrors.description = "Please provide a description or issue.";
    ...
    <div className="p-4 max-w-2xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            <label htmlFor="country" className="block font-semibold mb-2">Country</label>
            <input
              type="text"
              id="country"
              name="country"
        ...
        <div>
          <label htmlFor="description" className="block font-semibold mb-2">Description/Issue</label>
          <textarea
            id="description"
            name="description"
      ...
      <div className="flex gap-4 justify-center mt-6 md:flex-row flex-col">
        <a href="https://github.com/OmkarGhadge24" target="_blank" rel="noopener noreferrer">
          <IoLogoGithub size={30} className="hover:text-yellow-600 transition-colors duration-300" />
        </a>
        <a href="https://linkedin.com/in/omkar-ghadge-996b80317" target="_blank" rel="noopener noreferrer">
          <IoLogoLinkedin size={30} className="hover:text-blue-600 transition-colors duration-300" />
        </a>
        <a href="mailto:omkarghadge68@gmail.com" target="_blank" rel="noopener noreferrer">
          <MdOutlineEmail size={30} className="hover:text-green-500 transition-colors duration-300" />
        </a>
      </div>
    </div>
  );
